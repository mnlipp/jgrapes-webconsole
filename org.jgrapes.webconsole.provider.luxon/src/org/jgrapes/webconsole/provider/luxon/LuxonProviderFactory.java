...
/**
 * A factory for creating {@link LuxonProvider}s.
 */
public class LuxonProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new LuxonProvider(componentChannel));
    }
