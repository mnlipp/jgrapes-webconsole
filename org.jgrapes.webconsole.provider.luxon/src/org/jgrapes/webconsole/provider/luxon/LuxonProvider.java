...
package org.jgrapes.webconsole.provider.luxon;
...
/**
 * Provider for the [luxon](https://moment.github.io/luxon/) library.
 */
public class LuxonProvider extends PageResourceProvider {
     ...
     */
    public LuxonProvider(Channel componentChannel) {
    ...
    public void onConsoleReady(ConsoleReady event, ConsoleConnection connection)
        ...
        connection.respond(new AddPageResources()
            .addScriptResource(new ScriptResource()
                .setScriptType("module").setProvides("luxon")
                .setScriptUri(event.renderSupport().pageResource(
                    "luxon/build/es6/luxon.js"))));
    }
}
