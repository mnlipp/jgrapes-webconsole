...
package org.jgrapes.webconsole.provider.lit;
...
/**
 * A factory for creating {@link LitProvider}s.
 */
public class LitProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new LitProvider(componentChannel));
    }
