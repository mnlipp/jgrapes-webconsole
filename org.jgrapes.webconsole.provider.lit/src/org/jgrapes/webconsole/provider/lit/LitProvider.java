...
/**
 * Provider for the [lit](https://lit.dev/) library.
 */
public class LitProvider extends PageResourceProvider {
     ...
     */
    public LitProvider(Channel componentChannel) {
    ...
    public void onConsoleReady(ConsoleReady event, ConsoleConnection connection)
        ...
        connection.respond(new AddPageResources()
            .addScriptResource(new ScriptResource()
                .setScriptType("module").setProvides("lit")));
    }
}
