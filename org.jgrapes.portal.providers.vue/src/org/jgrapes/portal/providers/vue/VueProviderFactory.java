...
package org.jgrapes.portal.providers.vue;
...
/**
 * A factory for creating {@link VueProvider}s.
 */
public class VueProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new VueProvider(componentChannel));
    }
