...
package org.jgrapes.webconsole.provider.browserrequire;
...
/**
 * Provider for the [Browser Require](https://github.com/rsms/browser-require) 
 * library.
 */
public class BrowserRequireProvider extends PageResourceProvider {
     ...
     */
    public BrowserRequireProvider(Channel componentChannel) {
    ...
    public void onConsoleReady(ConsoleReady event,
        ...
        consoleSession.respond(new AddPageResources()
            .addScriptResource(new ScriptResource()
                .setProvides("browser-require")
                .setScriptUri(event.renderSupport().pageResource(
                    "browser-require/require"+ minExt + ".js"))));
    }
}
