...
/**
 * A factory for creating {@link BrowserRequireProvider}s.
 */
public class BrowserRequireProviderFactory
    ...
    public Class<? extends ComponentType> componentType() {
        return BrowserRequireProvider.class;
    }
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new BrowserRequireProvider(componentChannel));
    }
