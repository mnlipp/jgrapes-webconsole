...
package org.jgrapes.webcon.provider.fontawesome;
...
/**
 * A factory for creating {@link FontAwesomeProvider}s.
 */
public class FontAwesomeProviderFactory implements PageResourceProviderFactory {
    ...
    public Class<? extends ComponentType> componentType() {
        return FontAwesomeProvider.class;
    }
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new FontAwesomeProvider(componentChannel));
    }
