...
a.value]})};a.prototype.keys=function(){return e(this,function(a){return a.key})};a.prototype.values=function(){return e(this,function(a){return a.value})};a.prototype.forEach=function(a,b){for(var c=this.entries(),d;!(d=c.next()).done;)d=d.value,a.call(b,d[1],d[0],this)};a.prototype[Symbol.iterator]=a.prototype.entries;var d=function(a,b){var d=b&&typeof b;"object"==d||"function"==d?c.has(b)?d=c.get(b):(d=""+ ++m,c.set(b,d)):d="p_"+b;var e=a.data_[d];if(e&&$jscomp.owns(a.data_,d))for(a=0;a<e.length;a++){var g=
e[a];if(b!==b&&g.key!==g.key||b===g.key)return{id:d,list:e,index:a,entry:g}}return{id:d,list:e,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},g=function(){var a={};return a.previous=a.next=a.head=a},m=0;return a},"es6","es3");
$jscomp.polyfill("Set",function(b){if(!$jscomp.ASSUME_NO_NATIVE_SET&&function(){if(!b||!b.prototype.entries||"function"!=typeof Object.seal)return!1;try{var a=Object.seal({x:4}),c=new b($jscomp.makeIterator([a]));if(!c.has(a)||1!=c.size||c.add(a)!=c||1!=c.size||c.add({x:4})!=c||2!=c.size)return!1;var e=c.entries(),g=e.next();if(g.done||g.value[0]!=a||g.value[1]!=a)return!1;g=e.next();return g.done||g.value[0]==a||4!=g.value[0].x||g.value[1]!=g.value[0]?!1:e.next().done}catch(m){return!1}}())return b;
...
$jscomp.polyfill("String.prototype.includes",function(b){return b?b:function(b,a){return-1!==$jscomp.checkStringArgs(this,b,"includes").indexOf(b,a||0)}},"es6","es3");$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(b,a){var c=$jscomp.checkStringArgs(this,b,"startsWith");b+="";var e=c.length,g=b.length;a=Math.max(0,Math.min(a|0,c.length));for(var m=0;m<g&&a<e;)if(c[a++]!=b[m++])return!1;return m>=g}},"es6","es3");var JGPortal={};
(function(){function b(){var a=(new Date).getTime();window.performance&&"function"===typeof window.performance.now&&(a+=performance.now());return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(f){var b=(a+16*Math.random())%16|0;a=Math.floor(a/16);return("x"==f?b:b&3|8).toString(16)})}function c(a){var f=a.requires;a.requires=[];f.forEach(function(b){r.has(b)||a.requires.push(b)});if(0<a.requires.length)t.push(a);else{f=$("head").get()[0];var b=document.createElement("script");a.source?
(b.text=a.source,a.provides.forEach(function(a){r.add(a)})):(b.src=a.uri,b.addEventListener("load",function(f){q.delete(b.src);a.provides.forEach(function(a){r.add(a)});f=t;t=[];f.forEach(function(a){c(a)});0==q.size&&E&&JGPortal.unlockMessageQueue()}),q.add(b.src));f.appendChild(b)}}function a(a,b,D){for(var f in a){var n=a[f];0===$("head > link[href='"+n+"']").length&&$("head link[href$='/portal.css']:last").after("<link rel='stylesheet' href='"+n+"'>")}b&&(a=$("style"),a.text(b),$("head link[href$='/portal.css']:last").after(a));
for(var d in D)b=D[d],b.uri&&0<$("head > script[src='"+b.uri+"']").length||c(b)}function d(a){var b=a.data("onLoad");if(b){b=b.split(".");for(var f=window;f&&0<b.length;)f=f[b.shift()];f&&"function"===typeof f&&f.apply(null,[a])}}function e(){return $(".portlet[data-portlet-id]").map(function(){return $(this).attr("data-portlet-id")}).get()}function g(){return $("#portlet-tabs").tabs().find("> div[data-portlet-id]").map(function(){return $(this).attr("data-portlet-id")}).get()}function m(a){var b=
...
JGPortal.sendRenderPortlet(a,"Edit",!0)}));b.includes("DeleteablePreview")&&(a.prepend("<span class='ui-icon ui-icon-delete portlet-delete'></span>"),a.find(".portlet-delete").on("click",function(){var a=$(this).closest(".portlet").attr("data-portlet-id");JGPortal.sendDeletePortlet(a)}));b.includes("View")&&(a.prepend("<span class='ui-icon ui-icon-fullscreen portlet-expand'></span>"),a.find(".portlet-expand").on("click",function(){var a=$(this).closest(".portlet").attr("data-portlet-id");u(a)?m(a):
JGPortal.sendRenderPortlet(a,"View",!0)}))}function C(a,b,c,e){var f=v(a);if(!f){f=$('<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"><div class="portlet-header ui-widget-header"><span class="portlet-header-text"></span></div><div class="portlet-content ui-widget-content"></div></div>');f.attr("data-portlet-id",a);f.find(".portlet-header").addClass("ui-widget-header ui-corner-all");B(f,b);var n=!1;$(".column").each(function(b){if(b>=w.length)return!1;var c=w[b];if(A(c,
a,a))return $(this).find(".portlet").each(function(b){b=$(this);var d=b.attr("data-portlet-id");if(!A(c,d,a))return b.before(f),n=!0,!1}),n||$(this).append(f),n=!0,!1});n||$(".column").first().prepend(f);p()}b=$(c);f.find(".portlet-header-text").text(b.attr("data-portlet-title"));c=f.find(".portlet-content");c.children().detach();c.append(b);d(b);e&&$("#portlet-tabs").tabs("option","active",0)}function p(){if(F){var a=[];$(".overview-panel").find(".column").each(function(b){var f=[];a.push(f);$(this).find("div.portlet[data-portlet-id]").each(function(a){f.push($(this).attr("data-portlet-id"))})});
var b=[],c=$("#portlet-tabs").tabs();c.find(".ui-tabs-nav .ui-tabs-tab").each(function(a){0<a&&(a=$(this).attr("aria-controls"),a=c.find("#"+a).attr("data-portlet-id"),b.push(a))});JGPortal.sendLayout(a,b)}}var l={debug:function(a){console&&console.debug&&console.debug(a)},info:function(a){console&&console.info&&console.info(a)},warn:function(a){console&&console.warn&&console.warn(a)},error:function(a){console&&console.error&&console.error(a)}};JGPortal.log=l;JGPortal.formatMemorySize=function(a,
...
null;this._connectRequested=!1;this._portalSessionId=sessionStorage.getItem("org.jgrapes.portal.sessionId");this._portalSessionId||(this._portalSessionId=b(),sessionStorage.setItem("org.jgrapes.portal.sessionId",this._portalSessionId));this._location=("https:"===window.location.protocol?"wss":"ws")+"://"+window.location.host+window.location.pathname;this._location.endsWith("/")||(this._location+="/");this._location+="portal-session/"+this._portalSessionId+"?q="+b();this._connectionLostNotification=
null};k.prototype.portalSessionId=function(){return this._portalSessionId};k.prototype._connect=function(){l.debug("Creating WebSocket for "+this._location);this._ws=new WebSocket(this._location);l.debug("Created WebSocket with redayState "+this._ws.readyState);var a=this;this._ws.onopen=function(){l.debug("OnOpen called for WebSocket.");null!=a._connectionLostNotification&&(a._connectionLostNotification.notification("close"),$("#server-connection-restored-notification").notification({autoClose:2E3}));
e().forEach(function(a){JGPortal.sendRenderPortlet(a,"Preview",!1)});g().forEach(function(a){JGPortal.sendRenderPortlet(a,"View",!1)});a._drainSendQueue();a._refreshTimer=setInterval(function(){0==a._sendQueue.length&&(a._inactivity+=x,0<y&&a._inactivity>=y&&(a.close(),$("#portal-session-suspended-dialog").dialog("option","buttons",{Ok:function(){$(this).dialog("close");a.connect()}}),$("#portal-session-suspended-dialog").dialog("open")),a._send({jsonrpc:"2.0",method:"keepAlive",params:[]}))},x)};
this._ws.onclose=function(b){l.debug("OnClose called for WebSocket.");null!==a._refreshTimer&&(clearInterval(a._refreshTimer),a._refreshTimer=null);a._ws=null;a._connectRequested&&(null==a._connectionLostNotification?a._connectionLostNotification=$("#server-connection-lost-notification").notification({error:!0,icon:"alert",destroyOnClose:!1}):a._connectionLostNotification.notification("open"),a._initiateReconnect())};this._ws.onmessage=function(b){b=JSON.parse(b.data);a._recvQueue.push(b);1===a._recvQueue.length&&
a._handleMessages()}};k.prototype.connect=function(){this._connectRequested=!0;this._connect()};k.prototype.close=function(){this._send({jsonrpc:"2.0",method:"disconnect",params:[this._portalSessionId]});this._connectRequested=!1;this._ws.close()};k.prototype._initiateReconnect=function(){if(!this._reconnectTimer){var a=this;this._reconnectTimer=setTimeout(function(){a._reconnectTimer=null;a._connect()},1E3)}};k.prototype._drainSendQueue=function(){for(;1==this._ws.readyState&&0<this._sendQueue.length;){var a=
this._sendQueue[0];try{this._ws.send(a),this._sendQueue.shift()}catch(n){l.warn(n)}}};k.prototype._send=function(a){this._sendQueue.push(JSON.stringify(a));this._drainSendQueue()};k.prototype.send=function(a){this._inactivity=0;this._send(a)};k.prototype.addMessageHandler=function(a,b){this._messageHandlers[a]=b};k.prototype._handleMessages=function(){for(;!(0===this._recvQueue.length||0<this._recvQueueLocks);){var a=this._recvQueue.shift(),b=this._messageHandlers[a.method];b?a.hasOwnProperty("params")?
b.apply(null,[].concat($jscomp.arrayFromIterable(a.params))):b():l.error("No handler for invoked method "+a.method)}};k.prototype.lockMessageReceiver=function(){this._recvQueueLocks+=1};k.prototype.unlockMessageReceiver=function(){--this._recvQueueLocks;0==this._recvQueueLocks&&this._handleMessages()};var h=new k;JGPortal.lockMessageQueue=function(){h.lockMessageReceiver()};JGPortal.unlockMessageQueue=function(){h.unlockMessageReceiver()};var x,y;JGPortal.init=function(a,b){x=a;y=b;$("body").faLoading({icon:"fa-circle-o-notch",
spin:!0,text:!1});$("#theme-menu").on("click","[data-theme-id]",function(){JGPortal.sendSetTheme($(this).data("theme-id"));$("#theme-menu").jqDropdown("hide")});$("#language-menu").on("click","[data-locale]",function(){JGPortal.sendSetLocale($(this).data("locale"));$("#theme-menu").jqDropdown("hide")});$("#addon-menu").on("click","[data-portlet-type]",function(){JGPortal.sendAddPortlet($(this).data("portlet-type"));$("#theme-menu").jqDropdown("hide")});$("#portlet-tabs").tabs();var c=$("#portlet-tabs").tabs();
c.on("click","span.ui-icon-close",function(){var a=$(this).closest("li").remove().attr("aria-controls");$("#"+a).remove();c.tabs("refresh");p()});$("#portal-session-suspended-dialog").dialog({autoOpen:!1,modal:!0});$(".column").sortable({connectWith:".column",handle:".portlet-header",cancel:".portlet-toggle",placeholder:"portlet-placeholder ui-corner-all",stop:function(a,b){p()}});JGPortal.sendPortalReady()};var r=new Set,t=[],q=new Set,E=!1;h.addMessageHandler("addPageResources",a);h.addMessageHandler("addPortletType",
function(b,c,d,e,g){a(d,null,e);b=$('<li class="ui-menu-item"><div class="ui-menu-item-wrapper" data-portlet-type="'+b+'">'+c+"</div></li>");$("#addon-menu-list").append(b)});var w=[[],[],[]],F=!1,z={};h.addMessageHandler("lastPortalLayout",function(a,b){w=a;0<q.size&&(JGPortal.lockMessageQueue(),E=!0)});h.addMessageHandler("reload",function(){window.location.reload(!0)});JGPortal.registerPortletMethod=function(a,b,c){var f=z[a];f||(f={},z[a]=f);f[b]=c};h.addMessageHandler("notifyPortletView",function(a,
b,c,d){(a=z[a])&&(c=a[c])&&c(b,d)});h.addMessageHandler("portalConfigured",function(){F=!0;p();$("body").faLoading("remove")});JGPortal.findPortletPreview=function(a){a=$(".portlet[data-portlet-id='"+a+"']");if(1===a.length)return $(a[0])};var v=JGPortal.findPortletPreview;JGPortal.findPortletView=function(a){a=$("#portlet-tabs").tabs().find("> div[data-portlet-id='"+a+"']");if(1===a.length)return $(a[0])};var u=JGPortal.findPortletView;JGPortal.updatePortletViewTitle=function(a,b){var c=$("#portlet-tabs").tabs();
a=c.find("> div[data-portlet-id='"+a+"']");0!==a.length&&(a.find("[data-portlet-title]").attr("data-portlet-title",b),a=a.attr("id"),c=c.find("a[href='#"+a+"']"),c.empty(),c.append(b))};JGPortal.updatePortletModes=function(a,b){(a=v(a))&&B(a,b)};var G=1;h.addMessageHandler("updatePortlet",function(a,b,c,e,g){if("Preview"===b||"DeleteablePreview"===b)C(a,c,e,g);else if("View"===b){c=u(a);e=$(e);if(c)c.children().detach(),c.append(e);else{b=$("#portlet-tabs").tabs();G+=1;c="portlet-tabs-"+G;var f=$("<li><a href='@{href}'>@{label}</a> <span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>".replace(/@\{href\}/g,
"#"+c).replace(/@\{label\}/g,e.attr("data-portlet-title")));b.find(".ui-tabs-nav").append(f);c=$("<div id='"+c+"'></div>");c.append(e);c.attr("data-portlet-id",a);b.append(c);b.tabs("refresh");p()}d(e);g&&m(a)}else"Edit"===b&&(g=$(e),g.dialog({modal:!0,width:"auto"}),g.attr("data-portlet-id",a),d(g))});h.addMessageHandler("deletePortlet",function(a){var b=u(a);b&&(b=b.closest(".ui-tabs-panel").remove().attr("id"),$("#portlet-tabs").tabs().find("li[aria-controls='"+b+"']").remove(),$("#portlet-tabs").tabs().tabs("refresh"));
(a=v(a))&&a.remove();p()});h.addMessageHandler("retrieveLocalData",function(a){var b=[];try{for(var c=0;c<localStorage.length;c++){var d=localStorage.key(c);if(!a.endsWith("/")){if(d!==a)continue}else if(!d.startsWith(a))continue;var f=localStorage.getItem(d);b.push([d,f])}}catch(I){l.error(I)}JGPortal.sendLocalData(b)});h.addMessageHandler("storeLocalData",function(a){try{for(var b in a){var c=a[b];"u"===c[0]?localStorage.setItem(c[1],c[2]):"d"===c[0]&&localStorage.removeItem(c[1])}}catch(H){l.error(H)}});
h.addMessageHandler("displayNotification",function(a,b){$(a).notification(b)});h.connect();JGPortal.sendPortalReady=function(){h.send({jsonrpc:"2.0",method:"portalReady"})};JGPortal.sendSetTheme=function(a){h.send({jsonrpc:"2.0",method:"setTheme",params:[a]})};JGPortal.sendSetLocale=function(a){h.send({jsonrpc:"2.0",method:"setLocale",params:[a]})};JGPortal.sendRenderPortlet=function(a,b,c){h.send({jsonrpc:"2.0",method:"renderPortlet",params:[a,b,c]})};JGPortal.sendAddPortlet=function(a){h.send({jsonrpc:"2.0",
method:"addPortlet",params:[a,"Preview"]})};JGPortal.sendDeletePortlet=function(a){h.send({jsonrpc:"2.0",method:"deletePortlet",params:[a]})};JGPortal.notifyPortletModel=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];void 0===d?h.send({jsonrpc:"2.0",method:"notifyPortletModel",params:[a,b]}):h.send({jsonrpc:"2.0",method:"notifyPortletModel",params:[a,b,d]})};JGPortal.sendLayout=function(a,b){h.send({jsonrpc:"2.0",method:"portalLayout",params:[a,b]})};JGPortal.sendLocalData=
function(a){h.send({jsonrpc:"2.0",method:"retrievedLocalData",params:[a]})}})();(function(){JGPortal.tooltip=function(b){b.tooltip({items:"[data-tooltip-id], [title]",content:function(){var b=$(this);if(b.is("[data-tooltip-id]")){b=b.attr("data-tooltip-id");var a=$("#"+b);return a?(a=a.clone(!0),a.removeClass("jgrapes-tooltip-prototype"),a):"<#"+b+">"}if(b.is("[title]"))return b.attr("title")}})}})();
