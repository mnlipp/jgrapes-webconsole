...
a).remove();c.tabs("refresh");p()});$("#portal-session-suspended-dialog").dialog({autoOpen:!1,modal:!0});$(".column").sortable({connectWith:".column",handle:".portlet-header",cancel:".portlet-toggle",placeholder:"portlet-placeholder ui-corner-all",stop:function(a,b){p()}});JGPortal.sendPortalReady()};var r=new Set,t=[],q=new Set,E=!1;h.addMessageHandler("addPageResources",a);h.addMessageHandler("addPortletType",function(b,c,d,e,g){a(d,null,e);b=$('<li class="ui-menu-item"><div class="ui-menu-item-wrapper" data-portlet-type="'+
b+'">'+c+"</div></li>");$("#addon-menu-list").append(b)});var w=[[],[],[]],F=!1,z={};h.addMessageHandler("lastPortalLayout",function(a,b){w=a;0<q.size&&(JGPortal.lockMessageQueue(),E=!0)});h.addMessageHandler("reload",function(){window.location.reload(!0)});JGPortal.registerPortletMethod=function(a,b,c){var f=z[a];f||(f={},z[a]=f);f[b]=c};h.addMessageHandler("notifyPortletView",function(a,b,c,d){(a=z[a])&&(c=a[c])&&c(b,d)});h.addMessageHandler("portalConfigured",function(){F=!0;p();$("body").faLoading("remove")});
