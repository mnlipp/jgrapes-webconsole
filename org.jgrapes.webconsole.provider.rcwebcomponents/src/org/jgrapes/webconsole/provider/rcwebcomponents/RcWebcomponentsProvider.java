...
package org.jgrapes.webconsole.provider.rcwebcomponents;
...
/**
 * Provider for the
 * [rc-webcomoponents](https://github.com/richardcarls/rc-webcomponents)
 * library.
 */
public class RcWebcomponentsProvider extends PageResourceProvider {
     ...
     */
    public RcWebcomponentsProvider(Channel componentChannel) {
    ...
    public void onConsoleReady(ConsoleReady event, ConsoleConnection connection)
        ...
        connection.respond(new AddPageResources()
            .addScriptResource(new ScriptResource().setRequires("lit")
                .setScriptType("module").setProvides("rc-webcomponents")
                .setScriptSource("import '" + event.renderSupport()
                    .pageResource(
                        "rc-webcomponents/@rcarls/rc-webcomponents/define.js")
                    .getPath() + "';\n")));
    }
}
