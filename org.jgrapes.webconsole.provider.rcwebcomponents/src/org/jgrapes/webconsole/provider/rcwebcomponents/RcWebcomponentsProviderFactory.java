...
/**
 * A factory for creating {@link RcWebcomponentsProvider}s.
 */
public class RcWebcomponentsProviderFactory
    ...
    public Class<? extends ComponentType> componentType() {
        return RcWebcomponentsProvider.class;
    }
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new RcWebcomponentsProvider(componentChannel));
    }
