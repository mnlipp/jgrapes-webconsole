...
package org.jgrapes.webconsole.provider.forkawesome;
...
/**
 * Provider for [Fork Awesome](https://github.com/ForkAwesome/Fork-Awesome).
 */
public class ForkAwesomeProvider extends PageResourceProvider {
     ...
     */
    public ForkAwesomeProvider(Channel componentChannel) {
    ...
    public void onConsoleReady(ConsoleReady event, ConsoleConnection connection)
        ...
        connection.respond(new AddPageResources()
            .addCss(event.renderSupport().pageResource(
                "fork-awesome/css/fork-awesome" + minExt + ".css")));
    }
}
