...
/**
 * A factory for creating {@link ForkAwesomeProvider}s.
 */
public class ForkAwesomeProviderFactory implements PageResourceProviderFactory {
    ...
    public Class<? extends ComponentType> componentType() {
        return ForkAwesomeProvider.class;
    }
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new ForkAwesomeProvider(componentChannel));
    }
