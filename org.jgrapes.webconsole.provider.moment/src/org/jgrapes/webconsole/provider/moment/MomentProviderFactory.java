...
/**
 * A factory for creating {@link MomentProvider}s.
 */
public class MomentProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new MomentProvider(componentChannel));
    }
