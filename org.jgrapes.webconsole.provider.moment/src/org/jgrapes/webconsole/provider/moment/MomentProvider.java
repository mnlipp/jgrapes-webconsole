...
package org.jgrapes.webconsole.provider.moment;
...
/**
 * Provider for the [moment.js](http://momentjs.com/) library.
 */
public class MomentProvider extends PageResourceProvider {
     ...
     */
    public MomentProvider(Channel componentChannel) {
    ...
    public void onPortalReady(ConsoleReady event, ConsoleSession portalSession)
        ...
        portalSession.respond(new AddPageResources()
            .addScriptResource(new ScriptResource()
                .setProvides(new String[] { "moment", "moment-with-locales" })
                .setScriptUri(event.renderSupport().pageResource(
                    "moment/moment-with-locales" + minExt + ".js"))));
    }
}
