...
public class Forkawesome extends AbstractProject
        implements JavaProject, JavaLibraryProject {

    public Forkawesome() {
        super(name("org.jgrapes.webconsole.provider.forkawesome"));
        dependency(Expose, project(Base.class));
        Root.addNpmResourcesBuilder(
            Root.prepareNpm(dependency(Supply, NpmExecutor::new)),
            Path.of(
                "org/jgrapes/webconsole/provider/forkawesome/fork-awesome"),
            FileTree.of(this, Path.of("node_modules/fork-awesome"), "**/*"));
    }
}
