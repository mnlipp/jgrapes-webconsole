...
public class Vuex extends AbstractProject
        implements JavaProject, JavaLibraryProject {

    public Vuex() {
        super(name("org.jgrapes.webconsole.provider.vuex"));
        dependency(Expose, project(Base.class));
        Root.addNpmResourcesBuilder(
            Root.prepareNpm(dependency(Supply, NpmExecutor::new)),
            Path.of("org/jgrapes/webconsole/provider/vuex/vuex"),
            FileTree.of(this, Path.of("node_modules/vuex/dist"),
                "*-browser.*"));
    }
}
