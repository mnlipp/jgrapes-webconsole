...
package org.jgrapes.webconsole.provider.vuex;
...
/**
 * A factory for creating {@link VuexProvider}s.
 */
public class VuexProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new VuexProvider(componentChannel));
    }
