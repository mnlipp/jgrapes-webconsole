...
/**
 * A {@link Principal} representing a role used by web console
 * components. Console roles are usually not managed. Rather, the
...
public class ConsoleRole implements Principal {
    ...
    /**
     * Instantiates a new console role with the name also being used 
     * as display name.
     *
     * @param name the name
     */
    ...
    public boolean equals(Object obj) {
        ...
        ConsoleRole other = (ConsoleRole) obj;
