 ...
 */
public class HelloSolidConletFactory implements ConletComponentFactory {

    @Override
    public Class<? extends ComponentType> componentType() {
        return HelloSolidConlet.class;
    }

    @Override
    public Optional<ComponentType> create(
            Channel componentChannel, Map<?, ?> properties) {
        return Optional.of(new HelloSolidConlet(componentChannel));
    }
