...
$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");$jscomp.polyfill("Object.values",function(b){return b?b:function(b){var f=[],d;for(d in b)$jscomp.owns(b,d)&&f.push(b[d]);return f}},"es8","es3");$jscomp.polyfill("Array.prototype.values",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b,f){return f})}},"es8","es3");var JGPortal={};
...
function(a){this.filterKey=$(a.target).val()};JGPortal.TableController.prototype.clearFilter=function(a){$(a.target).closest("form").find("input").val("");this.filterKey=""};JGPortal.TableController.prototype.breakBeforeDots=function(a){return String(a).replace(/\./g,"&#x200b;.")};JGPortal.OptionsSet=function(){this.enabled=new Map;this.disabled=new Map};JGPortal.OptionsSet.prototype.set=function(a,b){this.enabled.set(a,b);this.disabled.delete(a)};JGPortal.OptionsSet.prototype.get=function(a){return this.enabled.get(a)};
JGPortal.OptionsSet.prototype.getEnabled=function(){return this.enabled.keys()};JGPortal.OptionsSet.prototype.getDisabled=function(){return this.disabled.keys()};JGPortal.OptionsSet.prototype.getAll=function(){return(new Set([].concat($jscomp.arrayFromIterable(this.enabled.keys()),$jscomp.arrayFromIterable(this.disabled.keys())))).values()};JGPortal.OptionsSet.prototype.clear=function(){this.enabled.clear();this.disabled.clear()};JGPortal.OptionsSet.prototype.delete=function(a){this.enabled.delete(a);
this.disabled.delete(a)};JGPortal.OptionsSet.prototype.disable=function(a){this.enabled.has(a)&&(this.disabled.set(a,this.enabled.get(a)),this.enabled.delete(a))};JGPortal.OptionsSet.prototype.enable=function(a){this.disabled.has(a)&&(this.enabled.set(a,this.disabled.get(a)),this.disabled.delete(a))};JGPortal.OptionsSet.prototype.toggleEnabled=function(a){this.enabled.has(a)?this.disable(a):this.enable(a)};JGPortal.OptionsSet.prototype.toggleIsSet=function(a,b){this.enabled.has(a)?this.enabled.delete(a):
this.enabled.set(a,b)}})();
