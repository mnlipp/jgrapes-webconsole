...
spin:!0,text:!1});$("#theme-menu").on("click","[data-theme-id]",function(){a.send("setTheme",$(this).data("theme-id"));$("#theme-menu").jqDropdown("hide")});$("#language-menu").on("click","[data-locale]",function(){a.sendSetLocale($(this).data("locale"));$("#theme-menu").jqDropdown("hide")});$("#addon-menu").on("click","[data-portlet-type]",function(){a.sendAddPortlet($(this).data("portlet-type"));$("#theme-menu").jqDropdown("hide")});$("#portlet-tabs").tabs();var c=$("#portlet-tabs").tabs();c.on("click",
"span.ui-icon-close",function(){var b=$(this).closest("li").remove().attr("aria-controls");$("#"+b).remove();c.tabs("refresh");a._layoutChanged()});$("#portal-session-suspended-dialog").dialog({autoOpen:!1,modal:!0});$(".preview-area").sortable({handle:".portlet-header",cancel:".portlet-toggle",placeholder:"portlet-placeholder ui-corner-all",stop:function(c,b){a._layoutChanged()}})};JQUIPortal.Renderer.prototype.connectionLost=function(){null==this._connectionLostNotification?this._connectionLostNotification=
...
JQUIPortal.Renderer.prototype.portletRemoved=function(a){a.forEach(function(a){a=$(a);if(a.hasClass("portlet-view")){var c=a.closest(".ui-tabs-panel").remove().attr("id");$("#portlet-tabs").tabs().find("li[aria-controls='"+c+"']").remove();$("#portlet-tabs").tabs().tabs("refresh")}a.hasClass("portlet-preview")&&a.remove()});this._layoutChanged()};JQUIPortal.Renderer.prototype.notification=function(a,c){$(a).notification(c)};JQUIPortal.Renderer.prototype._layoutChanged=function(){var a=[];$(".overview-panel").find(".preview-area").find(".portlet-preview[data-portlet-id]").each(function(){a.push($(this).attr("data-portlet-id"))});
var c=[],b=$("#portlet-tabs").tabs();b.find(".ui-tabs-nav .ui-tabs-tab").each(function(a){0<a&&(a=$(this).attr("aria-controls"),a=b.find("#"+a).attr("data-portlet-id"),c.push(a))});this.sendLayout(a,c,{})};JQUIPortal.Renderer.prototype.updatePortletTitle=function(a,c){var b=$("#portlet-tabs").tabs(),d=b.find("> .portlet-view[data-portlet-id='"+a+"']");0<d.length&&(d.find("[data-portlet-title]").attr("data-portlet-title",c),d=d.attr("id"),b=b.find("a[href='#"+d+"']"),b.empty(),b.append(c));if(a=this.findPortletPreview(a))a=
$(a).find(".portlet-header-text"),a.empty(),a.append(c)};JQUIPortal.Renderer.prototype.updatePortletModes=function(a,c){(a=this.findPortletPreview(a))&&this._setModeIcons(a,c)};JQUIPortal.Renderer.prototype.showEditDialog=function(a,c,b){var d=$(b);a.append(d);a.dialog({modal:!0,width:"auto",close:function(c,b){d.trigger("JGrapes.editDialog.apply",[a])}})}})();
