...
$jscomp.polyfill("Array.prototype.includes",function(b){return b?b:function(a,c){var e=this;e instanceof String&&(e=String(e));var b=e.length;for(c=c||0;c<b;c++)if(e[c]==a||Object.is(e[c],a))return!0;return!1}},"es7","es3");
...
spin:!0,text:!1});$("#theme-menu").on("click","[data-theme-id]",function(){a.send("setTheme",$(this).data("theme-id"));$("#theme-menu").jqDropdown("hide")});$("#language-menu").on("click","[data-locale]",function(){a.sendSetLocale($(this).data("locale"));$("#theme-menu").jqDropdown("hide")});$("#addon-menu").on("click","[data-portlet-type]",function(){a.sendAddPortlet($(this).data("portlet-type"),$(this).data("render-modes"));$("#theme-menu").jqDropdown("hide")});$("#portlet-tabs").tabs();var c=$("#portlet-tabs").tabs();
...
"buttons",{Ok:function(){$(this).dialog("close");a()}});$("#portal-session-suspended-dialog").dialog("open")};JQUIPortal.Renderer.prototype.portalConfigured=function(){this._layoutChanged();b.debug("Unlocking screen");$("body").faLoading("remove")};JQUIPortal.Renderer.prototype.addPortletType=function(a,c,b){var d=$('<li class="ui-menu-item"><div class="ui-menu-item-wrapper" data-portlet-type="'+a+'">'+c+"</div></li>");d.find("div").data("render-modes",b);var e=!1;$("#addon-menu-list").find(".ui-menu-item").each(function(a,
b){if(c<$(b).find(".ui-menu-item-wrapper").text())return $(b).before(d),e=!0,!1});e||$("#addon-menu-list").append(d)};JQUIPortal.Renderer.prototype.lastPortalLayout=function(a,c,b){this._lastPreviewLayout=a;this._lastTabsLayout=c;this._lastXtraInfo=b};JQUIPortal.Renderer.prototype.updatePortletPreview=function(a,c,b,d,f){var e=this;if(a){c.addClass("ui-widget ui-widget-content ui-helper-clearfix ui-corner-all");c.append('<div class="portlet-header ui-widget-header"><span class="portlet-header-text"></span></div><div class="portlet-content ui-widget-content"></div>');
c.find(".portlet-header").addClass("ui-widget-header ui-corner-all");this._setModeIcons(c,b);a=$(".preview-area");var g=!1,h=c.attr("data-portlet-id");e._isBefore(e._lastPreviewLayout,h,h)&&(a.find(".portlet").each(function(a){a=$(this);var c=a.attr("data-portlet-id");if(!e._isBefore(e._lastPreviewLayout,c,h))return a.before(portlet),g=!0,!1}),g||a.append(c),g=!0);g||a.first().prepend(c);this._layoutChanged()}d=$(d);c.find(".portlet-header-text").text(d.attr("data-portlet-title"));c=c.find(".portlet-content");
c.children().detach();c.append(d);f&&$("#portlet-tabs").tabs("option","active",0)};JQUIPortal.Renderer.prototype._isBefore=function(a,c,b){for(var e=0;e<a.length;e++){if(a[e]===c)return!0;if(a[e]===b)break}return!1};JQUIPortal.Renderer.prototype._setModeIcons=function(a,c){var b=this;a=a.find(".portlet-header");a.find(".ui-icon").remove();c.includes("Edit")&&(a.prepend("<span class='ui-icon ui-icon-wrench portlet-edit'></span>"),a.find(".portlet-edit").on("click",function(){var a=$(this).closest(".portlet").attr("data-portlet-id");
b.sendRenderPortlet(a,["Edit","Foreground"])}));c.includes("DeleteablePreview")&&(a.prepend("<span class='ui-icon ui-icon-delete portlet-delete'></span>"),a.find(".portlet-delete").on("click",function(){var a=$(this).closest(".portlet").attr("data-portlet-id");b.sendDeletePortlet(a)}));c.includes("View")&&(a.prepend("<span class='ui-icon ui-icon-fullscreen portlet-expand'></span>"),a.find(".portlet-expand").on("click",function(){var a=$(this).closest(".portlet").attr("data-portlet-id"),c=b.findPortletView(a);
c?b._activatePortletView(c):b.sendRenderPortlet(a,["View","Foreground"])}))};JQUIPortal.Renderer.prototype._activatePortletView=function(a){var c=$("#portlet-tabs").tabs();(a=a.index())&&c.tabs("option","active",a-1)};JQUIPortal.Renderer.prototype.updatePortletView=function(a,c,b,d,f){b=$(d);if(a){a=$("#portlet-tabs").tabs();this._tabCounter+=1;d="portlet-tabs-"+this._tabCounter;var e=$(this._tabTemplate.replace(/@\{href\}/g,"#"+d).replace(/@\{label\}/g,b.attr("data-portlet-title")));a.find(".ui-tabs-nav").append(e);
c.attr("id",d);c.append(b);a.append(c);a.tabs("refresh");this._layoutChanged()}else c.children().detach(),c.append(b);f&&this._activatePortletView(c)};JQUIPortal.Renderer.prototype.portletRemoved=function(a){a.forEach(function(a){a=$(a);if(a.hasClass("portlet-view")){var c=a.closest(".ui-tabs-panel").remove().attr("id");$("#portlet-tabs").tabs().find("li[aria-controls='"+c+"']").remove();$("#portlet-tabs").tabs().tabs("refresh")}a.hasClass("portlet-preview")&&a.remove()});this._layoutChanged()};JQUIPortal.Renderer.prototype.notification=
function(a,c){$(a).notification(c)};JQUIPortal.Renderer.prototype._layoutChanged=function(){var a=[];$(".overview-panel").find(".preview-area").find(".portlet-preview[data-portlet-id]").each(function(){a.push($(this).attr("data-portlet-id"))});var c=[],b=$("#portlet-tabs").tabs();b.find(".ui-tabs-nav .ui-tabs-tab").each(function(a){0<a&&(a=$(this).attr("aria-controls"),a=b.find("#"+a).attr("data-portlet-id"),c.push(a))});this.sendLayout(a,c,{})};JQUIPortal.Renderer.prototype.updatePortletTitle=function(a,
c){var b=$("#portlet-tabs").tabs(),d=b.find("> .portlet-view[data-portlet-id='"+a+"']");0<d.length&&(d.find("[data-portlet-title]").attr("data-portlet-title",c),d=d.attr("id"),b=b.find("a[href='#"+d+"']"),b.empty(),b.append(c));if(a=this.findPortletPreview(a))a=$(a).find(".portlet-header-text"),a.empty(),a.append(c)};JQUIPortal.Renderer.prototype.updatePortletModes=function(a,c){(a=this.findPortletPreview(a))&&this._setModeIcons(a,c)};JQUIPortal.Renderer.prototype.showEditDialog=function(a,c,b){var e=
$(b);a.append(e);a.dialog({modal:!0,width:"auto",close:function(c,b){e.trigger("JGrapes.editDialog.apply",[a])}})}})();(function(){JQUIPortal.tooltip=function(b){b.tooltip({items:"[data-tooltip-id], [title]",content:function(){var a=$(this);if(a.is("[data-tooltip-id]")){a=a.attr("data-tooltip-id");var c=$("#"+a);return c?(c=c.clone(!0),c.removeClass("jgrapes-tooltip-prototype"),c):"<#"+a+">"}if(a.is("[title]"))return a.attr("title")}})}})();
