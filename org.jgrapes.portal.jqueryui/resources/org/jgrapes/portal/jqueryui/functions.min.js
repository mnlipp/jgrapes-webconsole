...
"buttons",{Ok:function(){$(this).dialog("close");a()}});$("#portal-session-suspended-dialog").dialog("open")};JQUIPortal.Renderer.prototype.portalConfigured=function(){this._layoutChanged();b.debug("Unlocking screen");$("body").faLoading("remove")};JQUIPortal.Renderer.prototype.addPortletType=function(a,c,b){a=$('<li class="ui-menu-item"><div class="ui-menu-item-wrapper" data-portlet-type="'+a+'">'+c+"</div></li>");a.find("div").data("render-modes",b);$("#addon-menu-list").append(a)};JQUIPortal.Renderer.prototype.lastPortalLayout=
