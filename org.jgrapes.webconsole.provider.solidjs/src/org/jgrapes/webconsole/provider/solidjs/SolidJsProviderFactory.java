...
package org.jgrapes.webconsole.provider.solidjs;
...
/**
 * A factory for creating {@link SolidJsProvider}s.
 */
public class SolidJsProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new SolidJsProvider(componentChannel));
    }
