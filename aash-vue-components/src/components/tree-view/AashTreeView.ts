 ...
 * @param {ToggleVetoer} props.on_toggle an optional vetoer which is
 *      invoked before a node is opened or closed
 * @param {Function} props.on_toggle a function ((path: string[]) => void)
...
export default defineComponent({
    ...
    setup(props) {
        let ctrl = props._controller 
            || new Controller(props.roots, props.on_toggle, props.on_focus);
