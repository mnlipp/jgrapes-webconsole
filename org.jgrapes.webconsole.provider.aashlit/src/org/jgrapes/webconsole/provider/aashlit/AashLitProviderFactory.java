...
package org.jgrapes.webconsole.provider.aashlit;
...
/**
 * A factory for creating {@link AashLitProvider}s.
 */
public class AashLitProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new AashLitProvider(componentChannel));
    }
