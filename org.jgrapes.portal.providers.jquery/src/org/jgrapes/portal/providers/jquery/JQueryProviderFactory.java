...
package org.jgrapes.portal.providers.jquery;
...
/**
 * A factory for creating {@link JQueryProvider}s.
 */
public class JQueryProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new JQueryProvider(componentChannel));
    }
