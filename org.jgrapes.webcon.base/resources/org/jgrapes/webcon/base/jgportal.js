...
class PortalWebSocket {
    ...
    constructor(portal) {
        ...
        this._oldPortalSessionId = sessionStorage.getItem("org.jgrapes.webcon.base.sessionId");
    };
    ...
    _connect() {
        ...
        this._portalSessionId = sessionStorage.getItem("org.jgrapes.webcon.base.sessionId");
...
class Portal {
    ...
    init(portalSessionId, refreshInterval, inactivityTimeout, renderer) {
        ...
        sessionStorage.setItem("org.jgrapes.webcon.base.sessionId", portalSessionId);
