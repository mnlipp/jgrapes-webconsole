...
package org.jgrapes.portal.providers.gridstack;
...
/**
 * A factory for creating {@link GridstackProvider}s.
 */
public class GridstackProviderFactory implements PageResourceProviderFactory {
    ...
    public Class<? extends ComponentType> componentType() {
        return GridstackProvider.class;
    }
