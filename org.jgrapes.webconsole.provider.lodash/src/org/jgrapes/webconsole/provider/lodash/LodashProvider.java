...
/**
 * Provider for the [Lodash](https://lodash.com/) library.
 */
public class LodashProvider extends PageResourceProvider {
     ...
     */
    public LodashProvider(Channel componentChannel) {
