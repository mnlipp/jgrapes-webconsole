...
package org.jgrapes.webconsole.provider.lodash;
...
/**
 * A factory for creating {@link LodashProvider}s.
 */
public class LodashProviderFactory implements PageResourceProviderFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new LodashProvider(componentChannel));
    }
